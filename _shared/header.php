<?php
    ...
    if(!isset($pageTitle)){
      $pageTitle = "Terapia con Pablo - psicoterapeuta especializado en procesos de duelo, psicooncología y violencia de género. Ibiza y Burgos, España";
    }
...
<html class="no-js" lang="es">
  ...
  <head>
      ...
      <meta name="description" content="Pablo Rodríguez González: Psicoterapeuta especializado en procesos de duelo, psicooncología y violencia de género. Apoyo y acompañamiento a personas, parejas y familias así como formación a profesionales y empresas.">
      <meta name="keywords" content="psicoterapeuta, procesos de duelo, psicología, violencia de género, psicooncología, Ibiza, Burgos, España">
