...
<section id="noticias" class="news-section">
  <div class="section-wrapp main-content">
    <p id="noticia">A raíz de la crisis sanitaria  he abierto una <a href="terapias-individuales.php">línea de atención especializada en Covid-19</a>.</p>
  </div>
</section>
  ...
  <div class="section-wrapp main-content">
    ...
    <div id="texto-terapia" class="text-left">
      ...
      <p id="terapia-relacional" class="desc-terapia">
        ...
        El propósito de esta terapia es dar solución a problemas relacionales que aparecen en el seno de una familia o de una pareja. Es una terapia de duración limitada, donde nos centraremos en desarrollar estrategias y habilidades para afrontar conflictos comunes así como individuales.
        <br>
        <br>
        <br>
